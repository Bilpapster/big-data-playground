We list here the execution results of our solution for the third problem (movie analytics) tested on the \texttt{ecoli.txt} dataset. Task 1 (duration per country) produces the following results:
