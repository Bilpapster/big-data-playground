...
\begin{figure}[h]
  \centering
  \subfloat[label for first figure \todo replace image and caption]{
    \includegraphics[width=0.48\textwidth]{figures/in-out ICU.png}
    % \includegraphics[width=0.48\textwidth]{figures/multiplication-times-dif-n-1}
  }
  \subfloat[label for second figure \todo replace image and caption]{
    \includegraphics[width=0.48\textwidth]{figures/in-out ICU.png}
